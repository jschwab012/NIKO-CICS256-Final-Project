/**
  TEXTBOX class sourced from Mitko Nikov @ https://github.com/mitkonikov/Processing/blob/master/Text_Box/TEXTBOX.pde
*/
public class TEXTBOX {
  // potential TODO: refactor class members to be private
   ...
   public color BackgroundSelected = color(230, 230, 230);
